...
echo "The env is $ENV - in run-docker.sh"
docker run -v /var/go/.m2:/root/.m2:rw -v $PWD:/gauge -e ENV -i bharatak/docker-gauge-chromedriver:chromedriver-2.34 -- sh run.sh
